...
def genMenu(menu_opt,width, height,myfont):
    ...
    menu = [[(150,150,150),[width/2 - opt_width/2,height/2 - opt_height/2,opt_width,opt_height]],
            ...
            [(255,255,255),[width/2 ,height/2 - opt_height/6,opt_width/3,opt_height/48]],
            [(255,255,255),[width/2 ,height/2 + opt_height/12,opt_width/3,opt_height/48]],
            [(255,255,255),[width/2 + opt_width/6-opt_width/100,height/2 - opt_height/6 - opt_height/60,opt_width/50,opt_height/15]],
            [(255,255,255),[width/2 + opt_width/6-opt_width/100,height/2 + opt_height/12 - opt_height/60,opt_width/50,opt_height/15]]]
    return(menu)